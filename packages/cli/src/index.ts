...
program
  .name('exhuma')
  .description('Universal Component CLI — Add tactile, headless components to any project across 13 ecosystems')
  .version('0.1.1');
...
program
  .command('list')
  .description('List all available components in the Exhuma registry')
  .action(listCommand);
