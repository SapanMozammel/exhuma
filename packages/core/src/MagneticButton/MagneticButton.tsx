 ...
 */
export const MagneticButton = memo<MagneticButtonProps>(({ children, strength = 0.35, radius = 120, springDamping = 18, className = '', style, ...props }) => {
	...
	const handlePointerMove = useCallback(
		(e: React.PointerEvent<HTMLButtonElement>) => {
			...
			const result = calculateMagneticPull(e.clientX, e.clientY, centerX, centerY, radius, strength);
