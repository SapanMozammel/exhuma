...
export const tiltCardComponent: UniversalComponent = {
	...
	slug: 'tilt-card',
	category: 'cards',
	description: 'Interactive 3D mouse-tracking card tilt with dynamic glare effect, spring damping, and reverse mode.',
	version: '1.0.0',
	props: [
		{
			name: 'maxTilt',
		...
		},
		{
			...
			type: 'boolean',
			defaultValue: true,
			description: 'Dynamic specular glare reflection tracking mouse position.',
		},
		{
			name: 'maxGlareOpacity',
			label: 'Max Glare Opacity',
			type: 'number',
			defaultValue: 0.3,
			min: 0.05,
			max: 0.8,
			step: 0.05,
			description: 'Peak opacity for the specular radial glare reflection.',
		},
		{
			name: 'reverse',
			label: 'Reverse Tilt',
		...
		},
		{
			...
			type: 'boolean',
			defaultValue: false,
			description: 'Programmatically disable 3D tilt and specular glare reflections.',
		},
		{
			name: 'axis',
			label: 'Tilt Axis',
