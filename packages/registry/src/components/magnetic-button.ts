    ...
    return generateOuterLayerFiles(
      {
        ...
        defaultTailwindClass: 'relative inline-flex items-center justify-center rounded-xl bg-primary px-6 py-3 font-semibold text-primary-foreground shadow-md transition-shadow hover:shadow-lg cursor-pointer will-change-transform',
      },
      flavor,
      props
    );
