...
} = ({ children, cols = 3, gap = '1.5rem', className = '', style }) => {
...
export const BentoCard: React.FC<BentoCardProps> = ({ children, colSpan = 1, rowSpan = 1, className = '', style }) => {
	...
	return (
		<div
			...
			className={`exhuma-bento-card group border-border bg-card/60 hover:border-primary/40 relative overflow-hidden rounded-2xl border p-6 backdrop-blur-md transition-all duration-300 hover:shadow-xl ${className}`}
			style={{
...
export const BentoHeader: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({ children, className = '', ...props }) => (
	<div className={`exhuma-bento-header space-y-2 ${className}`} {...props}>
		{children}
	</div>
);

export const BentoContent: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({ children, className = '', ...props }) => (
	<div className={`exhuma-bento-content text-muted-foreground text-sm ${className}`} {...props}>
		{children}
	</div>
);

export const BentoVisual: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({ children, className = '', ...props }) => (
